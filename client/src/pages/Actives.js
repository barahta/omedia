...
function Contacts() {
    ...
    const companies = [
        {
            name: 'Учебно-тренировочный центр «АвиаТЕХ»',
            url: 'http://195.161.41.34:5004/',
            img: 'aviatech.svg',
        ...
        },
        {
            ...
            email: 'https://news@in-news.ru',
            aplication: '3.png'
        },
        {
            name: 'Центр детского творчества «Hope Kids»',
            url: 'http://195.161.41.34:5001/',
            img: 'hopekids.svg',
        ...
        },
        {
            ...
            url: 'http://195.161.41.34:5002/',
            img: 'hopefitnneslogo.svg',
    ...
    return (
        <div className={style.bodymain}>
            ...
            <div className={style.companies}>
                ...
                {group.map((com, index)=>(
                    <div key={index} className={style.firm}>
                        <div className={style.ontheleft} style={{backgroundImage: `url('${process.env.REACT_APP_API_URL}${com.logo}')`}}></div>
                        <div className={style.ontheright}>
                            <div className={style.upper}>
                                <div className={style.titlename}>{com.name}</div>
                                <div className={style.cover} style={{backgroundImage: `url('${process.env.REACT_APP_API_URL}${com.image}')`}}></div>
                                <div className={style.descript}>{com.desc}</div>
                            </div>

                        </div>
                        <div className={style.footer}>
                            <a href={(com.site)?com.site:''} target="_blank" rel="noopener noreferrer" className={style.urllink}>Перейти на сайт</a>
                            <div className={style.contact}>
                                {(com.contacts)&&com.contacts.map((contact, indexcontact)=>(
